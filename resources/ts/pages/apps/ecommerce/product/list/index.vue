...
<template>
  <div>
      ...
      <div class="d-flex flex-wrap gap-4 ma-6">
        ...
        <div class="d-flex gap-4 flex-wrap align-center">
          ...
          <VBtn
            ...
            @click="isAddPostDialogVisible = true"
          >
            Add Product
          </VBtn>
        </div>
    ...
    <AddEditPostDialog
        v-model:isDialogVisible="isPostDialogVisible"
        v-model:post-name="postName"
      />
      <AddEditPostDialog 
      v-model:isDialogVisible="isAddPostDialogVisible" 
      />
  </div>
</template>
